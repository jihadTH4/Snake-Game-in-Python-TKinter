...
# The constants Settings for the game (you can change as you want)
GAME_WIDTH = 800
GAME_HEIGHT = 600
SPEED = 150
SPACE_SIZE = 50
...
def game_over():
    canvas.create_text(GAME_WIDTH / 2, GAME_HEIGHT / 2, text="Game Over", font=("consolas", 50), fill="white")
